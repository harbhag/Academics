...
show_label('info','Generate Forwarding Memo');
echo "<br/>";

$paper_id = mysql_query("SELECT distinct  Sub_PaperID as paper_id, SUB_TITLE as subject_title FROM ptu_subjects WHERE 
...
echo "<center>
          ...
          <input type='hidden' name='sup_generate_formwardingmemo' value='sup_generate_formwardingmemo' />
