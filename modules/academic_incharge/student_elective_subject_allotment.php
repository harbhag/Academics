...
if(isset($_POST['student_elective_subject_insert']))
{
	...
	{
		$sql_ses = "SELECT * from student_elective_subjects where university_roll_no='".$_POST['university_roll_no'.$x]."' and semester='".$_POST['semester']."' and elective_details='".$_POST['elective_type']."' and theory_practical='".$_POST['theory_practical']."' ;";
		#echo $sql_ses;
		...
		#	echo $sql_delete_log;
			...
			$sql_delete="DELETE FROM `student_elective_subjects` WHERE university_roll_no='".$_POST['university_roll_no'.$x]."' and semester='".$_POST['semester']."' and elective_details='".$_POST['elective_type']."' and theory_practical='".$_POST['theory_practical']."' ; ";
		...
		$sql_ses_insert="INSERT INTO `student_elective_subjects`(`course_code`, `branch_code`, `semester`, `university_roll_no`, `paper_id`, `subject_title`, `subject_code`, `elective_details`, `m_code`, theory_practical, `scheme_master_id`) VALUES ('".$_POST['course_code']."', '".$_POST['branch_code']."', '".$_POST['semester']."', '".$_POST['university_roll_no'.$x]."', '".$row_els['paper_id']."', '".$row_els['subject_title']."','".$row_els['subject_code']."','".$row_els['elective_details']."', '".$row_els['m_code']."','".$_POST['theory_practical']."', '".$_POST['elective_subject'.$x]."')";
		#echo $sql_ses_insert;
...
if(isset($_POST['student_elective_subject_submit']))
{
	...
	while($row = mysql_fetch_array($result1))
	{
		...
		$result_elective_subject = mysql_query("SELECT  * from scheme_master where scheme_code= '".$_POST['scheme_code']."' and branch_code='".$_POST['branch_code']."' and elective_details='".$_POST['elective_type']."' and semester='".$_POST['semester']."' and theory_practical='".$_POST['theory_practical']."';" );
		
		
		$sql_ses = "SELECT * from student_elective_subjects where university_roll_no='".$row['university_roll_no']."' and semester='".$row['semester']."' and elective_details='".$_POST['elective_type']."' and theory_practical='".$_POST['theory_practical']."' ;";
		#echo $sql_ses;
		$result_ses= mysql_query($sql_ses);
		$row_ses = mysql_fetch_array($result_ses);
	...
	echo "<input type='hidden' name='theory_practical' value='".$_POST['theory_practical']."'>";
...
{	
	...
	form_dropdown_field('dropdown','','shift','student_info','shift','required');
		...
		echo "<option value='T'>Theory</option>
