...
<center>
	...
	<form method='post' action=''>
          ...
          while($row = mysql_fetch_assoc($scheme_master)) {
				...
				<tr><td>
					<span style='font-weight:bold'>Assignment No.</span>
					</td><td>
				<select name='assignment_no' id='assignment_no' class='input-medium'>";
          for($i=1;$i<=3;$i++) {
				...
				<tr><td>
					<input type='hidden' name='view_assignment_co_que_mapping_details_form' value='view_assignment_co_que_mapping_details_form' />
