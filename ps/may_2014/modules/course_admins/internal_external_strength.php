	...
	while($row_result = mysql_fetch_array($result_strength_list))
		{
			...
			{ 
				...
				$sql_sim_I = "SELECT * from student_internal_marks where  subject_master_id='".$row_result['SUB_ID']."' and internal_external='I' ;";
				...
				$sql_sim_E = "SELECT * from student_internal_marks where  subject_master_id='".$row_result['SUB_ID']."' and internal_external='E' ;";
				$result_sim_E = mysql_query($sql_sim_E);
				$row_sim_E = mysql_fetch_array($result_sim_E);
				#echo "$x ".$sql_subject."<br>";
