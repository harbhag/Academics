<?php
show_label('info','Analysis of Sessional Marks');
echo "<br/>";
...
sum(case when `q$x` >=0.90* mmq$x and  `attendance_status`='Present'  and `q$x` <=1.00* mmq$x  then 1 end) as Number_of_cand_90_100_Q$x,
...
echo "<tr><th>Number of students (90-100)% Question No.: $x</th><td>".$info['Number_of_cand_90_100_Q'.$x]."</td></tr>";
