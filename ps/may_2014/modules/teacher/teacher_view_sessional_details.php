...
show_label('info','Sessional Details');
echo "<br/>";
...
$result_iqs=mysql_query("select * from  internal_question_structure where course_code='".$_POST['course_code']."' and ass_tool='S' and sessional_no='1';");

$num_iqs_1= mysql_num_rows($result_iqs);

$result_iqs=mysql_query("select * from  internal_question_structure where course_code='".$_POST['course_code']."' and ass_tool='S' and sessional_no='2';");

$num_iqs_2= mysql_num_rows($result_iqs);

$result_iqs=mysql_query("select * from  internal_question_structure where course_code='".$_POST['course_code']."' and ass_tool='S' and sessional_no='3';");

$num_iqs_3= mysql_num_rows($result_iqs);
...
<table class='table table-bordered table-condensed container sortable'>
	<tr>
		...
		<th>Student Name</th>
		<? for($x=1;$x<=$num_iqs_1;$x++) 
		{
		$result_iqs_qn=mysql_query("select * from  internal_question_structure where course_code='".$_POST['course_code']."' and  question_no='".$x."' and ass_tool='S' and sessional_no='1' ;");
		...
		?>
		<th>S-1 (Total)</th>
		<? for($x=1;$x<=$num_iqs_2;$x++) 
		{
		$result_iqs_qn=mysql_query("select * from  internal_question_structure where course_code='".$_POST['course_code']."' and  question_no='".$x."' and ass_tool='S' and sessional_no='2' ");
		$row_iqs_qn = mysql_fetch_assoc($result_iqs_qn);
		echo "<th>Q:".$x." (".$row_iqs_qn['max_marks'].")</th>";
		}
		?>
		<th>S-2 (Total)</th>
		<? for($x=1;$x<=$num_iqs_3;$x++) 
		{
		$result_iqs_qn=mysql_query("select * from  internal_question_structure where course_code='".$_POST['course_code']."' and  question_no='".$x."'  and ass_tool='S' and  sessional_no='3' ");
		$row_iqs_qn = mysql_fetch_assoc($result_iqs_qn);
		echo "<th>Q:".$x." (".$row_iqs_qn['max_marks'].")</th>";
		}
		?>
