     ...
     <!--
      <label class="control-label">Date</label>
		 <div class="input-append date" id="dp<?php echo rand(); ?>" data-date="<?php echo date('Y-m-d'); ?>" data-date-format="yyyy-mm-dd">
				...
				<?php
				if($grace_period_allowed==1) {
					echo '<span class="add-on"><i class="icon-calendar"></i>';
				}
				?>
			  </div>
          ...
          <div class="controls">
            <select class="input-xlarge" name='attendance_date'>
             ...
             <?php
				...
				// echo "<option value='2014-08-28'>2014-08-28</option>";
				//echo "<option value='2014-04-15'>2014-04-4</option>";
				//}
			?>
            </select>
          </div>
