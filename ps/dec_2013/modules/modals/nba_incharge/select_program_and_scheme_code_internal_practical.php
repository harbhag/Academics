<div class="modal hide" id="select_program_and_scheme_code_internal_practical">
...
$branch_codes_sql = mysql_query("SELECT show_branch_code,show_course_code,show_semester FROM users WHERE username='".$_SESSION['username']."' AND usertype='nba_incharge'") or die(mysql_error());
...
?>
    ...
    <div class="control-group">
       ...
       <input type='hidden' name='add_internal_practical_co_que_mapping_subject_code' />
