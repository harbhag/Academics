	...
	{	
		...
		{	
			...
			if (($_POST['semester']=='1' || $_POST['semester']=='2') &&  $course_branch[0]=='1')
			{
				...
				sm.theory_practical,sm.paper_id,si.semester,si.university_roll_no,si.branch_code,UPPER(si.ptu_student_name), si.full_part_time,
				si.eligibility, si.course_code, si.shift, si.aicte_rc, si.admission_year, sm.elective_details,'Regular',si.student_status,UPPER(si.ptu_father_name),UPPER(si.ptu_mother_name),sm.m_code,si.batch,sm.scheme_code from
			...
			else
			{
				...
				{				
					...
					sm.elective_details,'Regular',si.student_status,UPPER(si.ptu_father_name),UPPER(si.ptu_mother_name),sm.m_code,si.batch,sm.scheme_code 
