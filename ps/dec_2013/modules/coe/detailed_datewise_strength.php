...
#$count ="SELECT  count( `Sub_PaperID` ) as count   FROM `cut_list_master` WHERE  `ucentre`='".$_POST['centre']."' AND `session`='".$_POST['session']."' AND date_of_exam='".$_POST['date_of_exam']."' ;";
$count ="SELECT  count( `Sub_PaperID` ) as count   FROM `ptu_subjects` WHERE  `ucentre`='".$_POST['centre']."' AND  `detention_status`='N' AND `received_status`='Y'  AND `usession`='".$_POST['session']."' AND date_of_exam='".$_POST['date_of_exam']."' ;";
