...
if (isset($_POST['security_code']) && isset($_POST['num']))
	...
	else if(isset($_POST['course_branch']) && isset($_POST['Semester']) && isset($_POST['Shift']) && isset($_POST['Full_Part_Time']))
	{
		...
		#echo $_POST['Branch_Name'];
		echo "<table class='table table-bordered striped table-condensed'><tr><th>Branch</th><th>Shift /<br>FT or PT /<br>AICTE or RC</th><th>Subject Title</th><th>Subject  Code</th><th>Semester</th><th>Subject Type</th><th>Select Faculty</th><!--<th>Internal<br /> Un-Lock</th>--><th>External<br /> Un-Lock</th><th>External<br /> Teacher</th><th>Internal<br /> Teacher</th></tr>";
