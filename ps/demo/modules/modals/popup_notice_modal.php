...
$pm_sql = mysql_query("SELECT * FROM popup_notices WHERE (usertype LIKE '%".$_SESSION['usertype']."%' OR  usertype LIKE 'ALL') AND valid_till>='".date("Y-m-d")."' AND published='Y' ORDER BY priority DESC") or die(mysql_error());
