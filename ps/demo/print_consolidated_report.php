...
$roll_nos = mysql_query("SELECT DISTINCT university_roll_no FROM student_info WHERE
		course_code='".$_POST['course_code']."' AND
		branch_code='".$_POST['branch_code']."' AND
		shift='".$_POST['shift']."' AND
		ssection='".$_POST['ssection']."' AND
...
<table style='width:100%'>
	  ...
	  <tr>
			<td colspan='6' align='center'><h3>Internal(Sessional) Theory Awards for Examination Nov.-Dec., 2013</h3></td>
			</tr>
			<tr>
...
while($row = mysql_fetch_assoc($roll_nos)) {
	...
	for($k=1;$k<=3;$k++) {
		$total_questions = mysql_query("SELECT * FROM internal_question_structure WHERE ass_tool='S' AND course_code='".$_POST['course_code']."'") or die(mysql_query());
