...
<table style='width:100%'>
	  ...
	  <tr>
			<td colspan='6' align='center'><h3>Internal Theory Awards (".$_POST['regular_reappear'].") for Examination ".$exam_session."</h3></td>
			</tr>
			<tr>
			...
			<td colspan='5'>".$_POST['subject_title']."(".$_POST['subject_code']." / ".$_POST['paper_id'].")</td>
			</tr>
			<tr>
...
while($row = mysql_fetch_assoc($data)) {
	...
	if($row['internal_attendance_status']!='Present') {
		...
		$num_to_word = $row['internal_attendance_status'];
			...
			<td align='left' >".$_POST['subject_code']." / ".$_POST['paper_id']."</td>
			<td align='left' >".$row['internal_attendance_status']."</td>
			<td align='left' >".$row['internal_obtained_marks']."</td>
	...
	$count++;
	  ...
	  <table border='1' cellpadding='2' style='border-collapse:collapse;width:100%'>
	  <tr>
	  <td colspan='6'>Result Analysis of students excluding Detained students. (Based on Obtained Marks)</td>
	  </tr>
	<tr>
...
// End Grade System
	...
	<tr>
	  ...
	  <table border='1' cellpadding='2' style='border-collapse:collapse;width:100%'>
	  <tr>
	  <td colspan='3' align='left'><b>Certified that all the candidates 
	  have completed the prescribed course of study and fulfilled all 
	  the conditions laid down in the Regulations for the examination 
	  and are eligible. The above marks have been matched with original 
	  award of each student. In case of any discrepancy in the award list, 
	  Internal examiners shall be responsible for the consequences. 
...
<b>Note:- Internal Examiner(s) are required to sign on every page with date. </b>
</body>";
...
$dompdf->render();
$dompdf->stream($_POST['subject_title']."_".$_POST['subject_code']."_".$_POST['semester']."_Internal(T).pdf");
