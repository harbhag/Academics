<div class="modal hide" id="update_sessional_marks<?php echo $count; ?>">
...
?> 
    ...
    <fieldset>
      <div id="legend" class="">
        <legend class="">Sessional Marks</legend>
      </div>
	...
	?>
            ...
            <div class="form-actions">
				<input type='hidden' name='update_sessional_marks_form_students' />
