...
show_label('info','Upload Internal Practical Marks');
echo "<br/>";
...
$dup = mysql_query("SELECT * FROM student_internal_practical_record WHERE
...
if(mysql_num_rows($dup)!=0) {
	...
	show_label('warning','Marks already Uploaded, Use "Update Internal Practical Record" option to edit the record.');
	exit();
}
?>
...
<input type='hidden' name='teacher_upload_internal_practical_marks' value='<?php echo $count; ?>' />
