...
function teacher_mark_daily_attendance() {
	...
	//echo $_POST['exam_year'];
		...
		$field_string = "branch_code,course_code,aicte_rc,shift,m_code,full_part_time,university_roll_no,ssection,sgroup,theory_practical,lecture_type,subject_code,elective_details,paper_id,subject_title,semester,teacher_username,teacher_type,attendance_date,attendance_period,start_time,end_time,overall_remarks,attendance,topics_covered,remarks,attendance_last_updated_on,attendance_last_updated_by,uploaded_from_ip,exam_month,exam_year";
