...
if(isset($_POST['qpp_generate_report'])) {
			include_once('modules/hod/qpp_generate_report.php');
}
...
if(isset($_POST['award_revision_report'])) {
			include_once('award_revision_report.php');
}
...
elseif(isset($_SESSION['usertype']) && isset($_SESSION['secure_auth'])) {
	if(!isset($_POST['logmeout'])) {
		...
		if(isset($_POST['question_paper_panel']) or isset($_POST['question_paper_panel_add']) or isset($_POST['question_paper_panel_delete'])) {
			
			include_once('modules/hod/question_paper_panel.php');
		}
		if(isset($_POST['question_paper_panel_report'])  or isset($_POST['qpp_lock_report'])) {
			
			include_once('modules/hod/question_paper_panel_report.php');
		}
		...
		if(isset($_POST['award_revision'])) {
			
			include_once('modules/course_admins/award_revision.php');
		}
		...
		if(isset($_POST['form_filled_strength'])) {
			include_once('modules/result_team/form_filled_strength.php');
		}
		if(isset($_POST['subject_count'])) {
			include_once('modules/result_team/subject_count.php');
		}
