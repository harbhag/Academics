...
elseif($_SESSION['usertype']=='hod') {
	include_once('navigator/hod.php');
	
}
elseif($_SESSION['usertype']=='result_team') {
	include_once('navigator/result_team.php');
	
}
elseif($_SESSION['usertype']=='university_project') {
	include_once('navigator/university_project.php');
