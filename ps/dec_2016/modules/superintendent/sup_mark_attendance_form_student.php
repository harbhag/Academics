...
while($row = mysql_fetch_assoc($roll_nos)) {
	...
	echo "<tr class='warning'>
			...
			<input type='hidden' name='aicte_rc$count' value='".$row['aicte_rc']."' />
			<input type='hidden' name='full_part_time$count' value='".$row['full_part_time']."' />
			<input type='hidden' name='shift$count' value='".$row['shift']."' />
...
<input type='hidden' name='exam_month' value='<?php echo $em; ?>' />
<input type='hidden' name='exam_year' value='<?php echo $ey; ?>' />
