			...
			<a class="brand" href="" name="top">Home</a>
				...
				<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
					...
					<li>
						...
						<button type="submit" name="submit" class="btn btn-danger" data-toggle='modal' href='#question_paper_panel'><i class="icon-file icon-white"></i>Question Paper Panel</button>
					</form>
					</li>
					...
					<!--<li>
					<form method="POST" action="" accept-charset="UTF-8">  
					<input type='hidden' name='question_paper_panel' value='question_paper_panel'/>                     
					<button type="submit" name="submit" class="btn btn-danger"><i class="icon-file icon-white"></i>Question Paper Panel</button>
					</form>
					</li>-->	
...
<?php include('modules/modals/hod/question_paper_panel.php'); ?>
