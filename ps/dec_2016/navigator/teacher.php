		...
		<div class="container-fluid">
			...
			<div class="btn-group pull-left">
					<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
						<i class="icon-folder-close"></i>Assessments <span class="caret"></span>
					</a>
					<ul class="dropdown-menu">
						...
						<button type="submit" name="submit" class="btn btn-danger"><i class="icon-file icon-white"></i> End Semester Exam  (Regular)</button>
						</form>
						</li>
						...
						<button type="submit" name="submit" class="btn btn-danger"><i class="icon-file icon-white"></i> End Semester Exam (Reappear)</button>
						</form>
						</li>
				...
				<div class="btn-group pull-left">
					...
					<ul class="dropdown-menu">
						...
						<button type="submit" name="submit" class="btn btn-danger"><i class="icon-file icon-white"></i>Mark Attendance (Lecture)</button>
						</form>
						</li>
						...
						<button type="submit" name="submit" class="btn btn-danger"><i class="icon-file icon-white"></i>Mark Attendance (Practical / Tutorial)</button>
						</form>
						</li>
