			...
			<a class="brand" href=""  name="top">Home</a>
				...
				<div class="btn-group pull-left">
					...
					<ul class="dropdown-menu">
						...
						<?php
						if($_SESSION['allow_award_revision']=='Y') {?>
						<li>
						<form method="POST" action="" accept-charset="UTF-8">  
						<input type='hidden' name='award_revision' value='award_revision' />
						<button type="submit" name="submit" class="btn btn-danger"><i class="icon-file icon-white"></i>Award Revision</button>
						</form>
						</li>
						...
						<li>
						<form method="POST" action="" accept-charset="UTF-8">  
						<input type='hidden' name='award_revision_record' value='award_revision_record' />
						<input type='hidden' name='award_revision' value='award_revision' />
						<button type="submit" name="submit" class="btn btn-danger"><i class="icon-file icon-white"></i>Award Revision Record</button>
						</form>
						</li>
						<?php }?>
				...
				<div class="btn-group pull-left">
					...
					<ul class="dropdown-menu">
							...
							<li>
						<a href="files/docs/course_admin/Remuneration_Bill_for_Practical_Examination.pdf" target="_blank">
						<i class="icon-file icon-reverse"></i>Remuneration Bill for Practical Examination
						</a>
						</li>
							<li>
						<a href="files/docs/course_admin/Bank_Detail_Form.pdf" target="_blank">
						<i class="icon-file icon-reverse"></i>Bank Detail Form
						</a>
						</li>
						
						<li>
						<a href="http://gndec.ac.in/sites/default/files/TA%20FORM%20NEW_0.pdf" target="_blank">
						<i class="icon-file icon-reverse"></i> TA/DA Proforma for External Examiners
						</a>
						</li>
					
						<li>
						<a href="files/docs/course_admin/practical_bill_performa_COE.xlsx" target="_blank">
						<i class="icon-file icon-reverse"></i> Summary Details for Practical Examination Bills
						</li>
						<li>
						<a href="files/docs/course_admin/Submission of Awards (Internal Theory,Practical and External Praactical).docx" target="_blank">
						<i class="icon-file icon-reverse"></i>Submission of Awards 
						</li>
					
						<li>
						<a href="files/docs/course_admin/TA_DA_distance_from_gndec.pdf" target="_blank">
						<i class="icon-file icon-reverse"></i> For TA/DA Distance From GNDEC
						</a>
						</li>
						<li>
						<a href="files/docs/course_admin/DRF_form.pdf" target="_blank">
						<i class="icon-file icon-reverse"></i> Discrepancy Redress Form 
						</a>
						</li>
					<!--	<li>
						<a href="files/docs/nstruction_admin.pdf" target="_blank">
						<i class="icon-file icon-reverse">Instruction Sheet</i>
						</a>
						</li>-->
