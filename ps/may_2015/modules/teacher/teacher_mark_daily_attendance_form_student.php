...
if(strtotime($_POST['attendance_date']) > time()) {
	
	show_label('info','Attendance cannot be marked for future date.');
	exit();
}
...
/*To here in order to skip checking time of period */
...
<table class='table table-bordered table-condensed sortable'>
	<tr>
		<th style='background-color:#D9EDF7'>Date / Period</th>
...
<input type='hidden' name='lecture_type' value='<?php echo $_POST['lecture_type']; ?>' />
