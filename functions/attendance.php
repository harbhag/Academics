...
function sup_mark_attendance() {
		...
		regular_reappear,attendance_last_updated,date_of_exam,ucentre,usession,attendance_uploaded_by,prov_nonprov,aicte_rc,full_part_time,shift,exam_month,exam_year,scheme_code";
