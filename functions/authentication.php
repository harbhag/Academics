...
function ldap_auth($user,$password){
  ...
  ldap_set_option($con, LDAP_OPT_PROTOCOL_VERSION, 3);
	...
	if($login['n_p']=='yes' && $password=='gndec1956') {
		...
		$_SESSION['show_branch_code'] = $login['show_branch_code'];
		$_SESSION['show_course_code'] = $login['show_course_code'];
		$_SESSION['show_semester'] = $login['show_semester'];
		$_SESSION['allow_award_revision'] = $login['allow_award_revision'];
...
function generate_secure_code() {
  ...
  */     
		...
		$subject = "GNDEC 2-Way Authentication Secret Code";
		$body = "".$secure_code." is your Secret Code for 2-Way Authentication";
